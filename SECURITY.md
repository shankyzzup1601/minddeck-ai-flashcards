...
Do not publish API keys, access codes, session cookies, exploit payloads, or personal study data in a public issue. Use GitHub's private vulnerability reporting feature for this repository when available. Revoke and rotate any credential immediately if exposure is suspected.
